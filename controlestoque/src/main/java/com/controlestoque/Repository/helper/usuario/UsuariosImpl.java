...
public class UsuariosImpl implements UsuariosQueries {
	...
	public List<String> permissoes(Usuario usuario) {
		return manager.createQuery(
				"select distinct p.nome from Usuario u inner join u.grupo_users g inner join g.permissoes p where u = :usuario",
...
//				for (Long codigoGrupo : filtro.getGrupo().stream().mapToLong(Grupo::getCodigo).toArray()) {
